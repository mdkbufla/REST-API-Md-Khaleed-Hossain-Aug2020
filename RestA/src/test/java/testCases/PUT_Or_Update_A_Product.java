...
public class PUT_Or_Update_A_Product {
	...
	GET_Read_A_Product readAproduct = new GET_Read_A_Product();
	...
	public void update_A_Product() {
		...
		payload.put("id", "1377");
		payload.put("name", "Khaleed Desktop Pro-10");
		payload.put("description", "GOOD");
		payload.put("price", "800" );
		...
		softAssert.assertEquals(message, "Product was updated.","Assertion  not matching!!");
		
		readAproduct.read_A_Product("1377");
